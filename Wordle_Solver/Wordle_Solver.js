    ...
    if (!boolGREENsTest) {                                          //word doesn't match Green pattern
      ...
      if (boolExclude) {                                            //word excludes all Exclude letters
        ...
        if (boolInclude) {                                          //word includes all Include letters
          aryFilteredFiveLetterWords.push(aryAllAnswersOrdered[wordIndex]);
          //consoleLog(logFiltering, 'pushing word: ' + word + ' AKA ' + aryAllAnswersOrdered[wordIndex]);
        }//if
      }//if boolExlude
